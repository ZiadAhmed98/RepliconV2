...
export default function LoadingOverlay({ text, subtext }) {
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: 4000, display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(9,9,11,0.9)', backdropFilter: 'blur(5px)' }}>
      {/* Fixed size box: width 380px, height 200px. Content is perfectly centered. */}
      <div style={{ background: 'var(--bg-card)', padding: '40px', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-card)', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '380px', height: '200px', gap: '20px' }}>
        ...
        <div style={{ textAlign: 'center', width: '100%' }}>
          ...
          {/* Real-time status injected here */}
