...
const COLUMNS = [
  ...
  { key: 'color',           label: 'Color',      render: v => <div style={{ width: '14px', height: '14px', borderRadius: '50%', background: v }} /> },
];
...
export default function SLAConfiguration() {
  ...
  async function submit() {
    setBusy(true);
    try { if (modal === 'add') await create(form); else await update(modal, form); setModal(null); } finally { setBusy(false); }
  }
