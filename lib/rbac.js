...
export const ALL_PAGES = [
  ...
  'clients', 'programs', 'accountManagers', 'templates',
  'aiInsights', 'chatbot', 'myTimesheet', 'timesheetApproval',
  'administration',
];

export const ROLE_DEFAULTS = {
  admin:      Object.fromEntries(ALL_PAGES.map(p => [p, true])),
  supervisor: { dashboard: true, employees: true, projects: true, clients: true, programs: true, accountManagers: true, templates: true, myTimesheet: true, timesheetApproval: true, timesheets: false, aiInsights: true, chatbot: true, administration: true },
  pm:         { myTimesheet: true, timesheetApproval: true, projects: true, clients: true, programs: true, accountManagers: true, templates: true, dashboard: true, chatbot: true, employees: false, timesheets: false, aiInsights: false, administration: false },
  resource:   { myTimesheet: true, chatbot: true, programs: false, accountManagers: false, templates: false, dashboard: false, employees: false, timesheets: false, projects: false, clients: false, aiInsights: false, timesheetApproval: false, administration: false },
};
