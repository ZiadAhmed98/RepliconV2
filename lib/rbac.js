...
// Default page permissions per employee role.
// Applied at login when the user account has no explicit permissions saved.
export const ROLE_DEFAULTS = {
  admin:      Object.fromEntries(ALL_PAGES.map(p => [p, true])),
  supervisor: { dashboard: true, employees: true, projects: true, clients: true, myTimesheet: true, timesheetApproval: true, timesheets: false, aiInsights: true, chatbot: true },
  pm:         { myTimesheet: true, timesheetApproval: true, projects: true, clients: true, dashboard: true, chatbot: true, employees: false, timesheets: false, aiInsights: false },
  resource:   { myTimesheet: true, chatbot: true, dashboard: false, employees: false, timesheets: false, projects: false, clients: false, aiInsights: false, timesheetApproval: false },
};
